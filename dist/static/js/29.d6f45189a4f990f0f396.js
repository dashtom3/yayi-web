  ...
  data() {
    return {
      ...
      rules: {
        ...
        type: [{ type: 'array', required: true, message: '请选择商品分类', trigger: 'change' }],
        itemBrandId: [{ type: 'number', required: true, message: '请选择品牌名称', trigger: 'change' }],
        itemSort: [{ required: true, message: '请选择商品类型', trigger: 'change' }],
...
var update = __webpack_require__(293)("3a5e4eb3", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('tr', {
      ...
      return (key != 'itemSkuPrice' && key != 'tiChen' && key != 'itemQb' && key != 'stockNum' && key != 'canUse') ? _c('td', [_vm._v(_vm._s(item))]) : _vm._e()
    }), _vm._v(" "), _c('td', {
      staticClass: "des_skuCode"
...
//# sourceMappingURL=29.d6f45189a4f990f0f396.js.map