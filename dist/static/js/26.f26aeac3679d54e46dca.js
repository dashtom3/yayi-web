  ...
  methods: {
    ...
    cancelBindSale: function (index, one) {
      ...
      that.$confirm('确定取消该绑定吗?', { confirmButtonText: '确定', cancelButtonText: '取消',
        ...
        that.global.axiosGetReq('/userManageList/disBind', obj).then(res => {
          if (res.data.callStatus === 'SUCCEED') {
...
var update = __webpack_require__(294)("1847c902", content, true);
...
//# sourceMappingURL=26.f26aeac3679d54e46dca.js.map